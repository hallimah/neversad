        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
           ...
           <!-- /.row -->
                  ...
                  <thead>
                    ...
                    <a onclick="return confirm ('Yakin hapus <?php echo $data['nama'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus customer" href="customer.php?hal=hapus&kd=<?php echo $data['kd_cus'];?>"><span class="glyphicon glyphicon-trash"></a></center></td>
                </tr></div>
                 <?php   
              } 
              ?>
