...
if (empty($_SESSION['username'])){
	...
	include "../conn.php";
        ...
        $input = mysqli_query($koneksi, "INSERT INTO po_terima(nopo, kd_cus, kode, tanggal,  ukuran, qty, total) SELECT session, session, kode, tanggal, ukuran, qty, jumlah FROM cart WHERE session='$_SESSION[user_id]'") or die(mysqli_error());
